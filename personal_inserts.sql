...
SELECT nombre,sal_emp + comision_emp +500 AS Total FROM empleados
WHERE id_depto=3000
ORDER BY nombre;
...
SELECT nombre,sal_emp, comision_emp, sal_emp + comision_emp +500 AS Total FROM empleados
...
SELECT MAX(sal_emp), MIN(sal_emp), MAX(sal_emp) - MIN(sal_emp) AS Dif FROM empleados;
